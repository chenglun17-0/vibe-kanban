...
<Frame>
<img src="/images/settings-beta-general.png" alt="Settings dialog showing the tabbed interface with General, Projects, Repositories, Agents, and MCP Servers tabs" />
</Frame>
