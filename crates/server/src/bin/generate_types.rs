...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::sessions::conversation_history::NativeHistoryErrorResponse::decl(),
        ...
        server::routes::task_attempts::pr::GeneratePrDescriptionRequest::decl(),
        server::routes::task_attempts::pr::GeneratePrDescriptionResponse::decl(),
        server::routes::task_attempts::pr::PrDescriptionStatus::decl(),
